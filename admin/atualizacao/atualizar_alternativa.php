...
<div class="container">
	<div class="row justify-content-center align-items-center">
	  	<div class="form-search">
			...
			<hr />
	  		<h4 style="text-align:center;">Por Favor, Insira a alternativa.</h4>
	  		<hr />
            <form method="post" action="../acoes.php">
                <div class="form-group">
                    <label for="pergunta">Selecione uma pergunta:</label>
                    <select class="custom-select mr-sm-2 mb-2" name="pergunta" onchange="gerarAlternativas(this.value)">
                ...
                <div class="form-group">     
                    <label for="alternativas">Selecione uma alternativa:</label>
                    <div id="alternativas"></div>    
                </div>
	            <div class="form-group">
                    <label for="nova_alternativa">Atualizar alternativa:</label>
                    
	                <input type="text" class="form-control" id="nova_alternativa" name="nova_alternativa" placeholder="Insira a nova alternativa" required>
	            </div>   
				<button type="submit" class="btn btn-lg btn-block btn-info" id="enviar">Atualizar</button>				
				<input type="hidden" value="5" id="tipo_formulario" name="tipo_formulario">
                <br />
