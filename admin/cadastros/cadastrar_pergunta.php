...
<head>
	...
	<title>Premio ACEPCDL - Cadastrar Categoria</title>
	  	...
	  	<div class="form-search">
		    ...
		    <form method="post" action="../acoes.php">
	            <div class="form-group">
	                <label for="login">Pergunta:</label>
	                <input type="text" class="form-control" id="pergunta" name="pergunta" placeholder="Digite o nome da pergunta" required>
	            </div>   
				<br />
				...
				<input type="hidden" value="2" id="tipo_formulario" name="tipo_formulario">
