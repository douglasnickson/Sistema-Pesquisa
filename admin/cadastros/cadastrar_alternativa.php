...
<head>
	...
	<title>Premio ACEPCDL - Cadastrar Alternativa</title>
...
<div class="container">
	<div class="row justify-content-center align-items-center">
	  	<div class="form-search">
			...
			<hr />
	  		<h4 style="text-align:center;">Por Favor, Selecione a pergunta e Insira a alternativa.</h4>
	  		<hr />
		    <form method="post" action="../acoes.php">
	            ...
	            <div class="form-group">
	                <label for="login">Alternativa:</label>
	                <input type="text" class="form-control" id="alternativa" name="alternativa" placeholder="Digite o titulo da alternativa" required>
	            </div>   
				<button type="submit" class="btn btn-lg btn-block btn-info" id="enviar">Cadastrar</button>
				<br />
				<p class="form-search-voltar" style="text-align:center;"><a href="../index.php">Voltar</a></p>				
				<input type="hidden" value="3" id="tipo_formulario" name="tipo_formulario">
